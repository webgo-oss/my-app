...
import { MeshoptDecoder } from 'https://cdn.skypack.dev/three@0.129.0/examples/jsm/libs/meshopt_decoder.module.js'; // Import MeshoptDecoder
...
loader12.setMeshoptDecoder(MeshoptDecoder);

let mixer12;
loader12.load('metallic_fluidity-v1.glb', (gltf) => {
